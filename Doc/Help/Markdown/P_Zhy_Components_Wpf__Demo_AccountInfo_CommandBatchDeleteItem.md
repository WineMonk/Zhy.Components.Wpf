...
**C#**
``` C#
[ZFormToolButtonAttribute("批量删除", Index = 1, ButtonStyle = ZFormButtonStyle.ErrorButton)]
public RelayCommand<IList?> CommandBatchDeleteItem { get; }
```
