...
**C#**
``` C#
[ZFormOperColumnButtonAttribute("更新", Index = 0, ButtonStyle = ZFormButtonStyle.WarnButton)]
public RelayCommand<Tuple<Object?, IList?>> CommandUpdateItem { get; }
```
